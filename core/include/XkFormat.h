...
std::string XkPublicFunction format(const std::string& fmt, const Any& value);
...
std::string XkPublicFunction format(const std::string& fmt, const Any& value1, const Any& value2);
std::string XkPublicFunction format(const std::string& fmt, const Any& value1, const Any& value2, const Any& value3);
std::string XkPublicFunction format(const std::string& fmt, const Any& value1, const Any& value2, const Any& value3, const Any& value4);
std::string XkPublicFunction format(const std::string& fmt, const Any& value1, const Any& value2, const Any& value3, const Any& value4, const Any& value5);
std::string XkPublicFunction format(const std::string& fmt, const Any& value1, const Any& value2, const Any& value3, const Any& value4, const Any& value5, const Any& value6);


void XkPublicFunction format(std::string& result, const std::string& fmt, const Any& value);
	/// Appends the formatted string to result.
	
void XkPublicFunction format(std::string& result, const std::string& fmt, const Any& value1, const Any& value2);
void XkPublicFunction format(std::string& result, const std::string& fmt, const Any& value1, const Any& value2, const Any& value3);
void XkPublicFunction format(std::string& result, const std::string& fmt, const Any& value1, const Any& value2, const Any& value3, const Any& value4);
void XkPublicFunction format(std::string& result, const std::string& fmt, const Any& value1, const Any& value2, const Any& value3, const Any& value4, const Any& value5);
void XkPublicFunction format(std::string& result, const std::string& fmt, const Any& value1, const Any& value2, const Any& value3, const Any& value4, const Any& value5, const Any& value6);


void XkPublicFunction format(std::string& result, const std::string& fmt, const std::vector<Any>& values);
