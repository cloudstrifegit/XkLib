...
/*! enum. UserDestructionPolicy
    desc.
        What to do when faced with deleting a user class that has originated outside of Xk.
    enums.
        UserDestructionPolicy_NeverDelete -- Don't delete. Pointer will be left as it is.
        UserDestructionPolicy_Delete -- Delete it, using the XK_DELETE macro.
...
/*! enum. ShapeFunctionType
    desc.
         A list of the possible functions of shapes in Xk.
    note.
